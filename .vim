...
if !exists("g:cpp_inc_dirs")
	let g:cpp_inc_dirs = '-Iinclude -Ilib'
endif
...
let g:syntastic_cpp_compiler_options="-std=c++14 -Werror -Wall -Wextra
	...
	\ -Weffc++ -Wold-style-cast ".g:cpp_inc_dirs." -I/usr/include/freetype2"

if match($OS, "Windows_NT") > -1
	let g:syntastic_cpp_compiler="c++.exe"
	let g:syntastic_cpp_compiler_options.=" -DMINGW64 -Ic:/mingw64/x86_64-w64-mingw32/include/freetype2"
endif
