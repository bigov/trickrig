...
/// \return
///
bool fb_base::init(GLsizei w, GLsizei h)
{
...
/// \return
///
pixel_info fb_base::read_pixel(GLint x, GLint y)
{
  glActiveTexture(GL_TEXTURE2);
...
/// \param height
///
void fb_base::resize(GLsizei w, GLsizei h)
{
  GLint lod = 0, frame = 0;
  ...
  glTexImage2D(GL_TEXTURE_2D, lod, GL_RGBA, w, h, frame, GL_RGBA, GL_UNSIGNED_BYTE, Bg.uchar());
  //glBindTexture(GL_TEXTURE_2D, 0);
